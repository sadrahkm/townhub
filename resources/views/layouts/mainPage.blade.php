...
<div id="main">
    ...
    <header class="main-header">
        ...
        <!-- header opt -->
        @if(Auth::check())
            <a href="{{ route('front.dashboard.listing.create') }}" class="add-list color-bg">Add Listing <span><i
            ...
            <div class="header-user-menu">
                <div class="header-user-name">
                    <span><img src="{{ \Illuminate\Support\Facades\Auth::user()->avatar_name }}"
                               alt="{{ \Illuminate\Support\Facades\Auth::user()->fullname }}"></span>
                    Hello , {{ ucwords(\Illuminate\Support\Facades\Auth::user()->fullname)  }}
                </div>
                <ul>
                            ...
                            @foreach(\Illuminate\Support\Facades\Auth::user()->wishlist as $event)
                                <li>
                                    <div class="widget-posts-img"><a
                                            href="{{ route('front.event.show',$event->id) }}"><img
...
<script src="/front/js/map-single.js"></script>
</body>

<!-- Mirrored from townhub.kwst.net/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 08 Feb 2020 16:42:06 GMT -->
</html>
