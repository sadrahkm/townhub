(function ($) {
    ...
    function mainMap() {
	    ...
	    //  Map Infoboxes ------------------
        var locations = [
            [locationData('www.google.com', '/images/all/1.jpg', 'Luxary Resaturant', " 27th Brooklyn New York, USA", 'cafe-cat', "5", "12", "open"  ), 40.72956781, -73.99726866, 0 , '/images/all/1.jpg'],
        ];
	    //   Map Infoboxes end ------------------
